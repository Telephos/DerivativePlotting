...
%I'm specifying the 'expected value' in the x and y axis with the 
%variable mux and muy. sigma 2 changes the variance. 
z2 = -exp(-(alpha2.*(((X-mux).^2)+((Y-muy).^2))/(2*sigma2.^2)));
%I add the values of z2 to z so that it's plotted as one continuous 
%manifold
z = z+z2;
